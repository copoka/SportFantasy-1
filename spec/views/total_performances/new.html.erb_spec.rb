...
RSpec.describe "total_performances/new", :type => :view do
  before(:each) do
    assign(:total_performance, TotalPerformance.new(
      :player_id => 1,
  ...
  it "renders new total_performance form" do
    render

    assert_select "form[action=?][method=?]", total_performances_path, "post" do
